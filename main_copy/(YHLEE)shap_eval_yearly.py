...
emis_ratio = pd.read_csv('/mnt/dsk1/yhlee/workdir/cmaqnet/datasets/emission_ratio_2013_2019.csv', index_col=0)
...
with strategy.scope():
    model = tf.keras.models.load_model(f'/mnt/dsk1/yhlee/workdir/cmaqnet/models_new/cond_unet_pm25_yearly')
    def pred(inputs):
    ...
    joblib.dump(explanation, f'/home/user/workdir/main/experiment/explanation_yearly_pm25_2019.shap',)
print("end")