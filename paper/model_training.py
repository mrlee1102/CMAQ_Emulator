...
# ================== Data Loading ==================
ctrl = pd.read_csv('/workdir/datasets/sector_control_2013.csv', index_col=0)
...
conc_dataset = np.load('/workdir/datasets/conc_pm25_total.npy')
...
conc_yearly_unet_model.save(f'/workdir/paper/models/cond_unet_pm25_{INDEX}')