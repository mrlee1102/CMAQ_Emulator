...
model_path = '/home/user/workdir/CMAQ_Emulator/main/src/model/pm25_prediction/PM25_MODEL_v1'
src_path = '/home/user/workdir/CMAQ_Emulator/pm25_model_compile/params'
try:
    postfix = ''
except:
    postfix = ''
...
with open(f"{src_path}/params.h", "w") as f_param:
    ...
    f_param.write("#define CMAQ_PAR_SECTOR_NUM           5\n")
    ...
    f_param.write("#define UNET_PAR_ROW_NUM              128\n")
    f_param.write("#define UNET_PAR_COL_NUM              96\n\n")
